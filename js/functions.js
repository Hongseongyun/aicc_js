...
overParams(1, 2, 3); // 1,2,3 출력
overParams(1, 2); // 1,2,undefined 출력 즉, 없는 부븐 undefined
overParams(1, 2, 3, 4); // 1,2,3출력 즉, 남는 부분 무시
