...
// json 데이터는 반복문을 사용하여 접근한다.
// for, forEach, map, filter, for in, for of
// forEach: DOM 반복 객체를 읽을 수 있다.
// map: DOM 반복 객체를 읽을 수 없다.
// json 데이터를 읽을 경우에는 일반적으로 map을 많이 사용한다.
